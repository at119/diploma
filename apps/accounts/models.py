...
class User(AbstractUser):
    ...
    mobile = models.CharField("Phone number", max_length=15, null=True, blank=True)
    gender = models.CharField("Gender", max_length=2, choices=GENDER_CHOICES, null=True, blank=True)
